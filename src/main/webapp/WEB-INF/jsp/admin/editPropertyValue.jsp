        ...
        <div class="workingArea">
            ...
            <div class="panel panel-warning editDiv" style="width: 400px;margin: 0 auto">
                ...
                <div class="panel-body">
                    <form method="post" id="editForm" action="admin_propertyValue_update"
                          enctype="multipart/form-data">
                        <table class="editTable">
                            <input type="hidden" name="ptid" value="${propertyValue.ptid}">
                            <input type="hidden" name="pid" value="${product.id}">
                            <input type="hidden" name="id" value="${propertyValue.id}">

                            <tr>
                                <td>属性值</td>
                                <td><input id="value" name="value" value="${propertyValue.value}" type="text"
