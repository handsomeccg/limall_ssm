        ...
        <c:forEach items="${orders}"  var="o">
            <table class="orderListItemTable" orderStatus="${o.status}" oid="${o.id}">
                <tr class="orderListItemFirstTR">
                    ...
                    <td colspan="2"><%--<img width="13px" src="img/site/orderItemTmall.png">--%>狸猫商场</td>
                    <td colspan="1">
                    ...
                    <td class="orderItemDeleteTD">
                        <a class="deleteOrderLink" href="/deleteOrder?oid=${o.id}">
                ...
                <c:forEach items="${o.orderItems}" var="oi" varStatus="st">
                    <tr class="orderItemProductInfoPartTR">
                        ...
                        <td class="orderItemProductInfoPartTD" width="100px">
                            ...
                            <div class="orderListItemProductOriginalPrice">￥${oi.product.originalPrice}</div>
                            <div class="orderListItemProductPrice">￥${oi.product.promotePrice}</div>
                        ...
                        <c:if test="${st.count==1}">
                            ...
                            <td valign="top" rowspan="${fn:length(o.orderItems)}"
                                ...
                                <c:if test="${o.status=='waitConfirm' }">
                                    <a href="confirmPay?oid=${o.id}">
                                        <button class="orderListItemConfirm">确认收货</button>
                                    </a>
                                </c:if>
                                <c:if test="${o.status=='waitPay' }">
                                    <a href="/payPage?oid=${o.id}&total=${o.total}">
                        ...
                        <td>
                            <c:if test="${o.status=='waitReview' }">
                                <c:if test="${oi.review!='1'}">
                                <a href="review?oid=${o.id}&pid=${oi.pid}">
                                    <button class="orderListItemReview">评价</button>
                                </a>
                                </c:if>
                            </c:if>
