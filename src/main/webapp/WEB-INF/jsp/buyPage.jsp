        ...
        <div class="address">
            ...
            <div>
                ...
                <table class="addressTable">
                    ...
                    <tr>
                        <td>邮政编码</td>
                        <td><input name="post" placeholder="请填写邮编" type="text"></td>
                    </tr>
                    <tr>
            ...
            <table class="productListTable">
                ...
                <tr>
                    <th colspan="2" class="productListTableFirstColumn">
                        <a class="marketLink" href="#nowhere">店铺：狸猫商城</a>
                ...
                <c:forEach items="${orderItems}" var="oi" varStatus="st">
                    <tr class="orderItemTR">
                        <td class="orderItemFirstTD"><img class="orderItemImg" src="img/product/${oi.pid}/1.jpg">
                        </td>
                        <td class="orderItemProductInfo">
                            <a href="siteproduct?pid=${oi.pid}" class="orderItemProductLink">
                                    ${oi.product.name}
                            </a>
                        ...
                        <td>
                                ...
                                <%--minFractionDigits="2"/>--%>
                                <%--</span>--%>
                            <span>${oi.product.promotePrice*oi.number}</span>
                        </td>
